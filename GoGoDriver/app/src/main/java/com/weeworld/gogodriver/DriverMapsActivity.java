...
import com.weeworld.gogodriver.Helper.DirectionJSONParser;
...
public class DriverMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("tel:" + Common.currentRequest.getNumberPhone()));
                if (ActivityCompat.checkSelfPermission(DriverMapsActivity.this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    return;
                }
    ...
    private void shippedOrder() {
        ...
        FirebaseDatabase.getInstance().getReference(Common.ORDER_NEED_SHIP_TABLE)
                .child(Common.currentShipper.getNumberPhone())
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        FirebaseDatabase.getInstance().getReference(Common.SHIPPER_INFO_TABLE)
                                                ...
                                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                    @Override
                                                    public void onSuccess(Void aVoid) {
                                                        Toast.makeText(DriverMapsActivity.this, "Đã Giao", Toast.LENGTH_SHORT).show();
                                                        finish();
                                                    }
                                                });
                                    }
...
//        clear all Polyline
        ...
        if (request.getAddress() != null && !request.getAddress().isEmpty()) {
            mService.getGeoCode(request.getAddress(), "AIzaSyC6cLsHE0CVPw7oZQy8t06xRH8C6A58j0E").enqueue(new Callback<String>() {
                @Override
                public void onResponse(Call<String> call, Response<String> response) {
                    try {
                        ...
                        MarkerOptions markerOptions = new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(bitmap))
                                .title("Đơn Hàng  " + Common.currentRequest.getNumberPhone())
                                .position(orderLocation);
                        mMap.addMarker(markerOptions);
                        //vẽ tuyến đường
                        mService.getDirections(yourLocation.latitude + "," + yourLocation.longitude,
                                orderLocation.latitude + "," + orderLocation.longitude, "AIzaSyC-KfNZm02axoLXYBlr2hrjHKm-VQkirHU")
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ProgressDialog mDialog = new ProgressDialog(DriverMapsActivity.this);
